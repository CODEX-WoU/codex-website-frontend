      ...
      <div className="grid grid-cols-4 gap-4 mt-5 ">
        ...
        <div className="  bg-black border-4 border-none rounded-lg shadow-xl min-h-[200px] col-span-2 text-white max-w-[500px]">
          <b>
            <h2 className="text-6xl font-serif">
              {" "}
              CODE<span className="text-red-600">&#123;X&#125;</span>
            </h2>
          </b>
          <br />
          <b>
            <h3 className="text-4xl font-serif">The Programming Club</h3>
          </b>
          <br />
          <div>
            <TypeAnimation
              sequence={["Code, Create and Innovate.", 2000, "", 1800]}
              speed={50}
              repeat={Infinity}
        ...
        <div className="bg-black border-4 border-none rounded-lg shadow-xl min-h-[200px] col-span-2 max-w-[500px]">
          <p className="text-white text-2xl font-serif">
            ...
            Join our student-led club for enriching workshops, dynamic
            hackathons, and specialized sessions. Unleash your potential,
            connect with like-minded peers, and shape a successful future in
            technology with us!
          </p>
        </div>
